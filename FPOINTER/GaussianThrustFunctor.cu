...
__host__ GaussianThrustFunctor::GaussianThrustFunctor (std::string n, Variable* _x, Variable* mean, Variable* sigma) 
...
__host__ fptype GaussianThrustFunctor::integrate (fptype lo, fptype hi) const {
