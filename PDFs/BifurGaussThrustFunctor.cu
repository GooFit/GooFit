...
__host__ BifurGaussThrustFunctor::BifurGaussThrustFunctor (std::string n, Variable* _x, Variable *mean, Variable* sigmaL, Variable* sigmaR)
...
__host__ fptype BifurGaussThrustFunctor::integrate (fptype lo, fptype hi) const {

  unsigned int* indices = host_indices + parameters; // look at the global indexes vector starting at the parameters of this function
