...
__host__ DalitzPlotThrustFunctor::DalitzPlotThrustFunctor (std::string n, 
							   Variable* m12, 
							   Variable* m13, 
...
__host__ void DalitzPlotThrustFunctor::setDataSize (unsigned int dataSize, unsigned int evtSize) {
...
__host__ fptype DalitzPlotThrustFunctor::normalise () const {
