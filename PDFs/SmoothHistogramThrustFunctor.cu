...
unsigned int SmoothHistogramThrustFunctor::totalHistograms = 0; 
...
__host__ void SmoothHistogramThrustFunctor::copyHistogramToDevice (thrust::host_vector<fptype>& host_histogram) {
