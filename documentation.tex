...
highest power. 
\item \texttt{ScaledGaussianThrustFunctor}: Another Gaussian variant. This one 
...
\begin{itemize}
\item \texttt{DalitzPlotHelpers}:
\item \texttt{DalitzPlotThrustFunctor}:
\item \texttt{DalitzVetoThrustFunctor}:
\item \texttt{devcomplex}:
\item \texttt{IncoherentSumThrustFunctor}:
\item \texttt{MixingTimeResolution\_Aux}:
\item \texttt{ResonanceThrustFunctor}:
\item \texttt{TddpThrustFunctor}:
\item \texttt{ThreeGaussResolution\_Aux}:
\item \texttt{ThrustPdfFunctor}:
\item \texttt{TrigThresholdThrustFunctor}:
\item \texttt{TruthResolution\_Aux}:
\end{itemize}
