...
GooPdf *vetoPdf() {
   ...
   //for Dzero veto
	...
	VetoInfo D0VetoInfoHigh(Variable("veto_Dzero_high_min", veto_min), Variable("veto_Dzero_high_max", veto_max), PAIR_13);

    vector<VetoInfo> vetos;
    vetos.push_back(D0VetoInfoLow);
    vetos.push_back(D0VetoInfoHigh);
    
    auto ret = new DalitzVetoPdf("vetoPdf", s12, s13, Mother_Mass, Daughter1_Mass, Daughter2_Mass, Daughter3_Mass, vetos); 
...
Amp3Body *makesignalpdf(GooPdf *eff = 0) {
    ...
    auto rho1450 = new Resonances::RBW("rho1450",v_rho1450_real,v_rho1450_img,v_rho1450_Mass,v_rho1450_Width,1,PAIR_12,true,false);
    ...
    auto rho1700 = new Resonances::RBW("rho1700",v_rho1700_real,v_rho1700_img,v_rho1700_Mass,v_rho1700_Width,1,PAIR_12,true,false);
    ...
    auto f0980 = new Resonances::FLATTE("f0980",v_f0980_real,v_f0980_img,v_f0980_Mass,v_f0980_gpi,v_f0980_gk,PAIR_12,true);
    ...
    auto Xc0_I = new Resonances::RBW("Xc0_I",v_Xc0_I_real,v_Xc0_I_img,v_Xc0_I_Mass,v_Xc0_I_Width,0,PAIR_12,true,false);
    ...
    auto NR = new Resonances::NonRes3k(
        "NR", v_NR_real, v_NR_img,v_NR_alpha);
...
void runfit1(){
    auto efficiency  = polyEff(); efficiency->setParameterConstantness(true);
...
void runfit2(){
    auto efficiency  = polyEff(); efficiency->setParameterConstantness(true);
    auto vetopdf = vetoPdf();  vetopdf->setParameterConstantness(true);
