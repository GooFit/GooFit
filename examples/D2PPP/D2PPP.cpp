...
Amp3Body *makesignalpdf(Observable s12, Observable s13, EventNumber eventNumber, GooPdf *eff = 0) {
    ...
    auto f0_1500 = new Resonances::RBW(
        "f0_1500", v_f0_1500_real, v_f0_1500_img, v_f0_1500_Mass, v_f0_1500_Width, 0, PAIR_12, true, true);
    ...
    auto f0_1710 = new Resonances::RBW(
        "f0_1710", v_f0_1710_real, v_f0_1710_img, v_f0_1710_Mass, v_f0_1710_Width, 0, PAIR_12, true, true);
    ...
    auto sigma
        = new Resonances::RBW("sigma", v_sigma_real, v_sigma_img, v_sigma_Mass, v_sigma_Width, 0, PAIR_12, true, true);
    ...
    auto omega
        = new Resonances::RBW("omega", v_omega_real, v_omega_img, v_omega_Mass, v_omega_Width, 1, PAIR_12, true, true);
    ...
    auto rho770 = new Resonances::GS(
        "rho770", v_rho770_real, v_rho770_img, v_rho770_Mass, v_rho770_Width, 1, PAIR_12, true, true);
    ...
    auto rho1450 = new Resonances::GS(
        "rho1450", v_rho1450_real, v_rho1450_img, v_rho1450_Mass, v_rho1450_Width, 1, PAIR_12, true, true);
    ...
    auto f2_1270 = new Resonances::RBW(
        "f2", v_f2_1270_real, v_f2_1270_img, v_f2_1270_Mass, v_f2_1270_Width, 2, PAIR_12, true, true);
...
void printContours(
    FCN fcn, ROOT::Minuit2::FunctionMinimum min, unsigned int par1, unsigned int par2, unsigned int pts) {
...
Amp3Body *runFit(
    GooPdf *totalPdf, Amp3Body *signal, UnbinnedDataSet *data, std::string name, bool genfit, unsigned int verbosity) {
    ...
    if(*genfit) {
        ...
        for(size_t i = 0; i < vec_nominal.size(); i++) {
            for(size_t j = 0; j < nfits; j++) {
                hist_vector[i]->Fill((vec_fits[j][i].getValue() - vec_nominal[i].getValue())
                                     / vec_fits[j][i].getError());
            }
