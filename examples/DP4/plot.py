...
plt.title(r'$(K^*\rho^0)_SPD\ m(\pi^+\pi^-)$', fontsize=20)
plt.legend()
...
plt.title(r'$(K^*\rho^0)_SPD\ K^-\pi^-$', fontsize=20)
plt.legend()
...
plt.title(r'$(K^*\rho^0)_SPD \ \phi$', fontsize=20)
plt.legend()
...
plt.title(r'$(K^*\rho^0)_SPD \ \cos(\theta_{12})$', fontsize=20)
plt.legend()
...
plt.title(r'$(K^*\rho^0)_SPD \ \cos(\theta_{34})$', fontsize=20)
plt.legend()
