...
int main (int argc, char** argv) {
  ...
  Amplitude* Bose_symmetrized_KF    = new Amplitude( "KF", new Variable("amp_real3", 0.0120787), new Variable("amp_imag3",  -0.0332525), LSKF, SFKF, 2);
  Amplitude* Bose_symmetrized_KK    = new Amplitude( "LSKK", new Variable("amp_real3", 0.0109033), new Variable("amp_imag3", -0.00186219), LSKK, SFKK, 2);
  Amplitude* Bose_symmetrized_K1R   = new Amplitude( "LSK1R", new Variable("amp_real3", -0.10728), new Variable("amp_imag3",  -0.130213), LSK1R, SFK1R, 2);
