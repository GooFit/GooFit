...
int main(int argc, char** argv) {
    ...
    Amplitude* Bose_symmetrized_AMP_S = new Amplitude("K*(892)rho(770)_S", new Variable("amp_real1", -0.115177),
            new Variable("amp_imag1", 0.153976), LSKRS, SFKRS, 2);
    ...
    Amplitude* Bose_symmetrized_AMP_D = new Amplitude("K*(892)rho(770)_D", new Variable("amp_real3", -0.452212),
            new Variable("amp_imag3", 0.426521), LSKRD, SFKRD, 2);
    Amplitude* Bose_symmetrized_KF    = new Amplitude("KF", new Variable("amp_real3", 0.0120787), new Variable("amp_imag3",
            -0.0332525), LSKF, SFKF, 2);
    Amplitude* Bose_symmetrized_KK    = new Amplitude("LSKK", new Variable("amp_real3", 0.0109033),
            new Variable("amp_imag3", -0.00186219), LSKK, SFKK, 2);
    Amplitude* Bose_symmetrized_K1R   = new Amplitude("LSK1R", new Variable("amp_real3", -0.10728),
            new Variable("amp_imag3",  -0.130213), LSK1R, SFK1R, 2);
    Amplitude* Bose_symmetrized_A1R   = new Amplitude("LSA1R", new Variable("amp_real3", 1.0), new Variable("amp_imag3",
            0.0), LSA1R, SFA1R, 2);
    Amplitude* Bose_symmetrized_A1RD  = new Amplitude("LSA1RD", new Variable("amp_real3", -0.94921),
            new Variable("amp_imag3",  -1.73407), LSA1RD, SFA1RD, 2);
