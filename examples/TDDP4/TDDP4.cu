...
int main(int argc, char** argv) {
    ...
    Amplitude* Bose_symmetrized_AMP_S = new Amplitude("K*(892)rho(770)_S", new Variable("amp_real1", 1.0),
            new Variable("amp_imag1", 0.0), LSKRS, SFKRS, 2);
    Amplitude* Bose_symmetrized_AMP_P = new Amplitude("K*(892)rho(770)_P", new Variable("amp_real2", 0.526),
            new Variable("amp_imag2", -0.626), LSKRP, SFKRP, 2);
    Amplitude* Bose_symmetrized_AMP_D = new Amplitude("K*(892)rho(770)_D", new Variable("amp_real3",  26.537),
            new Variable("amp_imag3", 12.284), LSKRD, SFKRD, 2);

    Amplitude* Bose_symmetrized_AMP_S_B = new Amplitude("B_K*(892)rho(770)_S", new Variable("amp_real1", 1.0),
            new Variable("amp_imag1", 0), LSKRS, SFKRS, 2);
    Amplitude* Bose_symmetrized_AMP_P_B = new Amplitude("B_K*(892)rho(770)_P", new Variable("amp_real2", -0.145),
            new Variable("amp_imag2", 0.86), LSKRP, SFKRP, 2);
    Amplitude* Bose_symmetrized_AMP_D_B = new Amplitude("B_K*(892)rho(770)_D", new Variable("amp_real3", 24.343),
            new Variable("amp_imag3", 5.329), LSKRD, SFKRD, 2);
    ...
    for(int k = 0; k < trials; ++k) {
        ...
        GOOFIT_INFO("Run #{}: Using accept-reject method would leave you with {} out of {} events", k, accepted, numEvents);
