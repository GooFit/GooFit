...
public:
    ...
    EXEC_TARGET void SetXYZE(fptype  x, fptype  y, fptype  z, fptype e) {
        X=x;
        Y=y;
        Z=z;
        E=e;
    ...
    EXEC_TARGET inline fptype GetX() const {
        return X;
    }
    EXEC_TARGET inline fptype GetY() const {
        return Y;
    }
    EXEC_TARGET inline fptype GetZ() const {
        return Z;
    }
    EXEC_TARGET inline fptype GetE() const {
        return E;
    }

    EXEC_TARGET inline fptype Mag2() const {
        return this->Dot(*this);
    }
    EXEC_TARGET inline fptype M() const {
        return SQRT(this->Mag2());
    }
    EXEC_TARGET inline void SetX(fptype a) {
        X=a;
    }
    EXEC_TARGET inline void SetY(fptype a) {
        Y=a;
    }
    EXEC_TARGET inline void SetZ(fptype a) {
        Z=a;
    }
    EXEC_TARGET inline void SetE(fptype a) {
        E=a;
    }
...
public:
    EXEC_TARGET const gpuLVec& v(int i) const {
        return _v[i];
    }
    ...
    EXEC_TARGET const gpuLVec& X() const {
        return _v[0];
    }
    EXEC_TARGET const gpuLVec& Y() const {
        return _v[1];
    }
    EXEC_TARGET const gpuLVec& Z() const {
        return _v[2];
    }
    EXEC_TARGET const gpuLVec& E() const {
        return _v[3];
    }

    EXEC_TARGET gpuLVec& X() {
        return _v[0];
    }
    EXEC_TARGET gpuLVec& Y() {
        return _v[1];
    }
    EXEC_TARGET gpuLVec& Z() {
        return _v[2];
    }
    EXEC_TARGET gpuLVec& E() {
        return _v[3];
    }

    EXEC_TARGET const gpuLVec& operator[](int i) const {
        return _v[i];
    }
    EXEC_TARGET gpuLVec& operator[](int i) {
        return _v[i];
    }
