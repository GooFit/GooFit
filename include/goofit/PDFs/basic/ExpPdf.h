...
class ExpPdf : public GooPdf {
  public:
    ExpPdf(std::string n, Observable *_x, Variable *alpha, Variable *offset = nullptr);
    ExpPdf(std::string n, Observable *_x, std::vector<Variable *> &weights, Variable *offset = nullptr);
