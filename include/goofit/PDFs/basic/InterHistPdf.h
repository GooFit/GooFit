...
histogram may have up to ten (\ref footnote1 "1") dimensions. Second, the dimensions
...
of the Gaussian (\ref footnote2 "2") at each \f$x\f$ given the \f$\sigma\f$ in that bin. Now
