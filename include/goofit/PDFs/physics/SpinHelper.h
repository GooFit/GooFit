...
public:
    ...
    __device__ gpuLVec(fptype x, fptype y, fptype z, fptype e)  :  X(x), Y(y), Z(z), E(e) {};
    ...
    __device__ fptype Dot(const gpuLVec& rhs) const {
        return E*rhs.E - X*rhs.X - Y*rhs.Y - Z*rhs.Z ;
    }
    __device__ inline fptype GetX() const {
        return X;
    }
    __device__ inline fptype GetY() const {
        return Y;
    }
    __device__ inline fptype GetZ() const {
        return Z;
    }
    __device__ inline fptype GetE() const {
        return E;
    }

    __device__ inline fptype Mag2() const {
    ...
    __device__ inline void SetY(fptype a) {
        Y=a;
    }
    __device__ inline void SetZ(fptype a) {
        Z=a;
    }
    __device__ inline void SetE(fptype a) {
        E=a;
    }
...
public:
    ...
    __device__ fptype Sandwich(const gpuLVec& lhs
...
public:
    __device__ SpinSumT(const gpuLVec& p, fptype mR)
        : _sv(p, mR)
    {}
    __device__ fptype Sandwich(const gpuLVec& lm
                                , const gpuLVec& ln
                                , const gpuLVec& ra
                                , const gpuLVec& rb
                               ) {
...
public:
    ...
    __device__ SymmLorentzMatrix(): LorentzMatrix() {}
