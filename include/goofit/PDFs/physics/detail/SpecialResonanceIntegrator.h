...
class SpecialResonanceIntegrator : public thrust::unary_function<thrust::tuple<int, fptype *, int>, thrust::tuple<fpcomplex, fpcomplex>> {
  public:
    ...
    __device__ auto operator()(thrust::tuple<int, fptype *, int> t) const -> thrust::tuple<fpcomplex, fpcomplex>;
