...
class SpecialSqDpDalitzIntegrator : public thrust::unary_function<thrust::tuple<int, fptype *, int>, ThreeComplex> {
  public:
    SpecialSqDpDalitzIntegrator(int pIdx, unsigned int ri, unsigned int rj);
