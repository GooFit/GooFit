...
OutputType reduce(goofit_policy& exec,
    ...
    thrust::system::cuda::detail::bulk_::async(
        thrust::system::cuda::detail::bulk_::par(s, g, decomp.size()),
    ...
    if(partial_sums.size() > 1) {
        ...
        thrust::system::cuda::detail::bulk_::async(
            ...
            thrust::system::cuda::detail::bulk_::root.this_exec, partial_sums.begin(), partial_sums.end(), partial_sums.begin(),
            binary_op);
    } // end if
