...
__host__ __device__
  OutputType transform_reduce(goofit_policy &exec,
                              InputIterator first,
                              InputIterator last,
...
template<typename InputIterator,
         ...
         typename BinaryFunction>
__host__ __device__
OutputType reduce (goofit_policy &exec,
                        InputIterator first,
                        InputIterator last,
                        OutputType init,
                        BinaryFunction binary_op)
{
  ...
  thrust::system::cuda::detail::bulk_::concurrent_group<
    thrust::system::cuda::detail::bulk_::agent<grainsize>,
    groupsize
  > g;
  ...
  thrust::system::cuda::detail::bulk_::async(
	thrust::system::cuda::detail::bulk_::par(s, g, decomp.size()), thrust::system::cuda::detail::reduce_detail::reduce_partitions(), 
	thrust::system::cuda::detail::bulk_::root.this_exec, first, decomp, partial_sums.begin(), init, binary_op).wait();

  if(partial_sums.size() > 1)
  {
    // reduce the partial sums
    thrust::system::cuda::detail::bulk_::async(
	thrust::system::cuda::detail::bulk_::par(s, g, 1), thrust::system::cuda::detail::reduce_detail::reduce_partitions(), 
	thrust::system::cuda::detail::bulk_::root.this_exec, partial_sums.begin(), partial_sums.end(), partial_sums.begin(), binary_op);
  } // end if
