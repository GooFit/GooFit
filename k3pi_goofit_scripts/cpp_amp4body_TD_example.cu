...
int main(int argc, char **argv) {
    ...
    //make filestream to save valid generated events
    std::ofstream event_file("amp4body_cpp_generated_events_false.txt");
    event_file << "m12" << " " << "m12" << " " << "c12" << " " << "c34" << " " << "phi" << " " << "dtime" << "\n";
    ...
    for(int k = 0; k < trials; ++k) {
        ...
        for(int i = 0; i < weights.size(); ++i) {
            if(flags[i] == 0) {
                ...
                //std::cout << "m12:" << tm12 << "m34:" << tm34 << "c12:" << tc12 << "c34:" << tc34 << "phi:" << tphi << "tdtime:" << tdtime << std::endl;
                event_file << tm12 << " " << tm34 << " " << tc12 << " " << tc34 << " " << tphi << " " << tdtime << "\n";
