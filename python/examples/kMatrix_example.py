...
def makeSignalPdf(m12, m13, eventNumber):
    ...
    # beta coeeficients
    beta_r = [
        Variable("beta1_r", 9.3 * cos(-78.7 * pi / 180)),
    ...
    beta_i = [
        Variable("beta1_i", 9.3 * sin(-78.7 * pi / 180)),
    ...
    # f_prod coefficients
    f_prod_r = [
        Variable("f_prod1_r", 7.94 * cos(73.9 * pi / 180)),
    ...
    f_prod_i = [
        Variable("f_prod1_i", 7.94 * sin(73.9 * pi / 180)),
    ...
    eff = PolynomialPdf(
        "constantEff", [m12, m13], [constantOne], [constantZero, constantZero], 0
    )
