...
f2_1270_amp_real = (
    Variable("f2_1270_amp_real", 1.43 * cos(-36.3 * pi / 180))
    if fixAmps
    else Variable("f2_1270_amp_real", 1.43 * cos(-36.3 * pi / 180), 0.0001, 0, 0)
)
f2_1270_amp_imag = (
    Variable("f2_1270_amp_imag", 1.43 * sin(-36.3 * pi / 180))
    if fixAmps
    else Variable("f2_1270_amp_imag", 1.43 * sin(-36.3 * pi / 180), 0.0001, 0, 0)
)
# f2_1270_mass = Variable("f2_1270_mass", 1.2755, 0.0001, 1.2755-20*0.0008, 1.2755+20*0.0008)
f2_1270_width = Variable(
    "f2_1270_width", 0.1867, 0.0001, 0.1867 - 3 * 0.0025, 0.1867 + 3 * 0.0022
)
f2_1270_mass = Variable("f2_1270_mass", 1.2755, 0.0001, 1.250, 1.300)
omega_782_amp_real = (
    Variable("omega_782_amp_real", 0.0388 * cos(120.7 * pi / 180))
    if fixAmps
    else Variable("omega_782_amp_real", 0.0388 * cos(120.7 * pi / 180), 0.0001, 0, 0)
)
omega_782_amp_imag = (
    Variable("omega_782_amp_imag", 0.0388 * sin(120.7 * pi / 180))
    if fixAmps
    else Variable("omega_782_amp_imag", 0.0388 * sin(120.7 * pi / 180), 0.0001, 0, 0)
)
...
rho_1450_amp_real = (
    Variable("rho_1450_amp_real", 2.85 * cos(102.1 * pi / 180))
    if fixAmps
    else Variable("rho_1450_amp_real", 2.85 * cos(102.1 * pi / 180), 0.0001, 0, 0)
)
rho_1450_amp_imag = (
    Variable("rho_1450_amp_imag", 2.85 * sin(102.1 * pi / 180))
    if fixAmps
    else Variable("rho_1450_amp_imag", 2.85 * sin(102.1 * pi / 180), 0.0001, 0, 0)
)
...
Kstarm_892_amp_real = (
    Variable("Kstarm_892_amp_real", 1.720 * cos(136.8 * pi / 180))
    if fixAmps
    else Variable("Kstarm_892_amp_real", 1.720 * cos(136.8 * pi / 180), 0.0001, 0, 0)
)
Kstarm_892_amp_imag = (
    Variable("Kstarm_892_amp_imag", 1.720 * sin(136.8 * pi / 180))
    if fixAmps
    else Variable("Kstarm_892_amp_imag", 1.720 * sin(136.8 * pi / 180), 0.0001, 0, 0)
)
...
K2starm_1430_amp_real = (
    Variable("K2starm_1430_amp_real", 1.27 * cos(-44.1 * pi / 180))
    if fixAmps
    else Variable("K2starm_1430_amp_real", 1.27 * cos(-44.1 * pi / 180), 0.0001, 0, 0)
)
K2starm_1430_amp_imag = (
    Variable("K2starm_1430_amp_imag", 1.27 * sin(-44.1 * pi / 180))
    if fixAmps
    else Variable("K2starm_1430_amp_imag", 1.27 * sin(-44.1 * pi / 180), 0.0001, 0, 0)
)
...
Kstarm_1680_amp_real = (
    Variable("Kstarm_1680_amp_real", 3.31 * cos(-118.2 * pi / 180))
    if fixAmps
    else Variable("Kstarm_1680_amp_real", 3.31 * cos(-118.2 * pi / 180), 0.0001, 0, 0)
)
Kstarm_1680_amp_imag = (
    Variable("Kstarm_1680_amp_imag", 3.31 * sin(-118.2 * pi / 180))
    if fixAmps
    else Variable("Kstarm_1680_amp_imag", 3.31 * sin(-118.2 * pi / 180), 0.0001, 0, 0)
)
Kstarm_1680_mass = Variable(
    "Kstarm_1680_mass", 1.718, 0.0001, 1.718 - 3 * 0.018, 1.718 + 3 * 0.018
)
...
Kstarm_1410_amp_real = (
    Variable("Kstarm_1410_amp_real", 0.29 * cos(99.4 * pi / 180))
    if fixAmps
    else Variable("Kstarm_1410_amp_real", 0.29 * cos(99.4 * pi / 180), 0.0001, 0, 0)
)
Kstarm_1410_amp_imag = (
    Variable("Kstarm_1410_amp_imag", 0.29 * sin(99.4 * pi / 180))
    if fixAmps
    else Variable("Kstarm_1410_amp_imag", 0.29 * sin(99.4 * pi / 180), 0.0001, 0, 0)
)
Kstarm_1410_mass = Variable(
    "Kstarm_1410_mass", 1.414, 0.0001, 1.414 - 2 * 0.015, 1.414 + 2 * 0.015
)
# Kstarm_1410_mass = Variable("Kstarm_1410_mass", 1.414, 0.0001, 1.410, 1.440)
Kstarm_1410_width = Variable(
    "Kstarm_1410_width", 0.232, 0.0001, 0.232 - 3 * 0.021, 0.232 + 3 * 0.021
)

Kstarp_892_amp_real = (
    Variable("Kstarp_892_amp_real", 0.164 * cos(-42.2 * pi / 180))
    if fixAmps
    else Variable("Kstarp_892_amp_real", 0.164 * cos(-42.2 * pi / 180), 0.0001, 0, 0)
)
Kstarp_892_amp_imag = (
    Variable("Kstarp_892_amp_imag", 0.164 * sin(-42.2 * pi / 180))
    if fixAmps
    else Variable("Kstarp_892_amp_imag", 0.164 * sin(-42.2 * pi / 180), 0.0001, 0, 0)
)
K2starp_1430_amp_real = (
    Variable("K2starp_1430_amp_real", 0.10 * cos(-89.6 * pi / 180))
    if fixAmps
    else Variable("K2starp_1430_amp_real", 0.10 * cos(-89.6 * pi / 180), 0.0001, 0, 0)
)
K2starp_1430_amp_imag = (
    Variable("K2starp_1430_amp_imag", 0.10 * sin(-89.6 * pi / 180))
    if fixAmps
    else Variable("K2starp_1430_amp_imag", 0.10 * sin(-89.6 * pi / 180), 0.0001, 0, 0)
)
Kstarp_1410_amp_real = (
    Variable("Kstarp_1410_amp_real", 0.21 * cos(150.2 * pi / 180))
    if fixAmps
    else Variable("Kstarp_1410_amp_real", 0.21 * cos(150.2 * pi / 180), 0.0001, 0, 0)
)
Kstarp_1410_amp_imag = (
    Variable("Kstarp_1410_amp_imag", 0.21 * sin(150.2 * pi / 180))
    if fixAmps
    else Variable("Kstarp_1410_amp_imag", 0.21 * sin(150.2 * pi / 180), 0.0001, 0, 0)
)

# LASS Kpi S wave parameters
K0star_1430_mass = Variable(
    "K0star_1430_mass", 1.425, 0.0001, 1.425 - 3 * 0.050, 1.425 + 3 * 0.050
)
K0star_1430_width = Variable(
    "K0star_1430_width", 0.270, 0.0001, 0.270 - 3 * 0.080, 0.270 + 3 * 0.080
)
...
phiR = (
    Variable("phiR", -1.91462619)
    if fixLass
    else Variable("phiR", -1.91462619, 0.0001, 0, 0)
)
F = Variable("F", 0.96) if fixLass else Variable("F", 0.96, 0.0001, 0, 0)
phiF = (
    Variable("phiF", 0.00174533)
    if fixLass
    else Variable("phiF", 0.00174533, 0.0001, 0, 0)
)

K0starp_1430_amp_real = (
    Variable("K0starp_1430_amp_real", 0.11 * cos(162.3 * pi / 180))
    if fixAmps
    else Variable("K0starp_1430_amp_real", 0.11 * cos(162.3 * pi / 180), 0.0001, 0, 0)
)
K0starp_1430_amp_imag = (
    Variable("K0starp_1430_amp_imag", 0.11 * sin(162.3 * pi / 180))
    if fixAmps
    else Variable("K0starp_1430_amp_imag", 0.11 * sin(162.3 * pi / 180), 0.0001, 0, 0)
)
K0starm_1430_amp_real = (
    Variable("K0starm_1430_amp_real", 2.36 * cos(99.4 * pi / 180))
    if fixAmps
    else Variable("K0starm_1430_amp_real", 2.36 * cos(99.4 * pi / 180), 0.0001, 0, 0)
)
K0starm_1430_amp_imag = (
    Variable("K0starm_1430_amp_imag", 2.36 * sin(99.4 * pi / 180))
    if fixAmps
    else Variable("K0starm_1430_amp_imag", 2.36 * sin(99.4 * pi / 180), 0.0001, 0, 0)
)
...
kMatrix_amp_real = (
    Variable("kMatrix_amp_real", 1)
    if fixAmps
    else Variable("kMatrix_amp_real", 1, 0.0001, 0, 0)
)
kMatrix_amp_imag = (
    Variable("kMatrix_amp_imag", 0)
    if fixAmps
    else Variable("kMatrix_amp_imag", 0, 0.0001, 0, 0)
)
...
def makeDecayInfo(mesrad, motherrad):
    ...
    # beta coeeficients
    beta_r = [
        Variable("beta1_r", 8.5 * cos(68.5 * pi / 180), 0.0001, 0, 0),
    ...
    beta_i = [
        Variable("beta1_i", 8.5 * sin(68.5 * pi / 180), 0.0001, 0, 0),
    ...
    # f_prod coefficients
    f_prod_r = [
        Variable("f_prod1_r", 8.0 * cos(-126.0 * pi / 180)),
    ...
    f_prod_i = [
        Variable("f_prod1_i", 8.0 * sin(-126.0 * pi / 180)),
...
def getData(filename, tree, catIndex):
    df = read_root(
        filename, tree, columns=["m12", "m13", "sig", "B_DTFKS_D0_CTAU", "D0_ID"]
    )
    ...
    df["D0_tag"] = np.where(
        df.D0_ID == 421, np.ones(df.shape[0]), np.repeat(-1, df.shape[0])
    )

    print(df)
    array = df[
        ["m12", "m13", "tau", "sig", "sigma", "mistag", "D0_tag", "category", "index"]
    ].to_numpy()

    dataset = UnbinnedDataSet(
        m12, m13, dtime, sigprob, sigma, mistag, charmtag, category, eventNumber
    )
...
def fillBGhist(filename, bghist_dalitz, bghist_dtime):
    ...
    hist, _, _ = np.histogram2d(
        dataframe.m12,
        dataframe.m13,
        weights=dataframe.sWeight_bkg,
        density=True,
        bins=m12.getNumBins(),
        range=[
            (m12.getLowerLimit(), m12.getUpperLimit()),
            (m12.getLowerLimit(), m12.getUpperLimit()),
        ],
    )
    ...
    hdtime, _ = np.histogram(
        dataframe.B_DTFKS_D0_CTAU / 0.3,
        weights=dataframe.sWeight_bkg,
        bins=dtime.getNumBins(),
        range=(dtime.getLowerLimit(), dtime.getUpperLimit()),
    )
...
def inDalitz(m12, m13):
    ...
    minimum = pow(E1 + E3, 2) - pow(
        sqrt(E1 * E1 - mKS * mKS) + sqrt(E3 * E3 - mPi * mPi), 2
    )
    maximum = pow(E1 + E3, 2) - pow(
        sqrt(E1 * E1 - mKS * mKS) - sqrt(E3 * E3 - mPi * mPi), 2
    )
...
def GetD0Fraction(dataset, charmtag, sigprob):
    ...
    for i in range(dataset.getNumEvents()):
        ...
        if dataset.getValue(charmtag, i) == 1:
            nD0 += dataset.getValue(sigprob, i)
...
def makePlots(total, signal, dataset, bkg_flag, string):
    ...
    data_tmp = UnbinnedDataSet(
        m12, m13, dtime, sigprob, sigma, mistag, charmtag, eventNumber
    )
    data_dtime = UnbinnedDataSet(
        m12, m13, dtime, sigprob, sigma, mistag, charmtag, eventNumber
    )
    ...
    for i in range(875):
        m12.setValue(
            m12.getLowerLimit()
            + (m12.getUpperLimit() - m12.getLowerLimit()) * (i + 0.5) / 875
        )
        for j in range(875):
            m13.setValue(
                m13.getLowerLimit()
                + (m13.getUpperLimit() - m13.getLowerLimit()) * (j + 0.5) / 875
            )
            if inDalitz(m12.getValue(), m13.getValue()):
                for k in range(10):
                    ...
                    if np.random.uniform() < d0fraction:
                        charmtag.setValue(1)
                    else:
                        charmtag.setValue(-1)
    ...
    hist_dat, binsx, binsy, _ = ax[0].hist2d(
        m12dat,
        m13dat,
        bins=175,
        range=[
    ...
    if bkg_flag:
        histsig, _ = np.histogram(
            m12val,
            weights=array[1],
            bins=175,
            range=(m12.getLowerLimit(), m12.getUpperLimit()),
        )
        histbkg, _ = np.histogram(
            m12val,
            weights=array[2],
            bins=175,
            range=(m12.getLowerLimit(), m12.getUpperLimit()),
        ...
        hist = hist * dataset.getNumEvents() / totalPdf
    hist_dat, bin_edges = np.histogram(
        m12dat, bins=175, range=(m12.getLowerLimit(), m12.getUpperLimit())
    )
    ...
    pars, cov = curve_fit(
        lambda pulls_nozero, mu, sig: norm.pdf(pulls_nozero, loc=mu, scale=sig),
        centers,
        npull,
        p0=[0, 1],
    )
    ...
    if bkg_flag:
        histsig, _ = np.histogram(
            ...
            weights=array[1],
            bins=175,
            range=(m13.getLowerLimit(), m13.getUpperLimit()),
        )
        histbkg, _ = np.histogram(
            m13val,
            weights=array[2],
    ...
    hist_dat, bin_edges = np.histogram(
        m13dat, bins=175, range=(m13.getLowerLimit(), m13.getUpperLimit())
    )
    ...
    for i in range(80):
        m12.setValue(
            m12.getLowerLimit()
            + (m12.getUpperLimit() - m12.getLowerLimit()) * (i + 0.5) / 80
        )
        for j in range(80):
            m13.setValue(
                m13.getLowerLimit()
                + (m13.getUpperLimit() - m13.getLowerLimit()) * (j + 0.5) / 80
            )
            if inDalitz(m12.getValue(), m13.getValue()):
    ...
    hist_dat, bin_edges = np.histogram(
        dtdat, bins=175, range=(dtime.getLowerLimit(), dtime.getUpperLimit())
    )
    # hist_dat = hist_dat*dataset.getNumEvents()/totalPdf
    bin_centre = (bin_edges[:-1] + bin_edges[1:]) / 2
    hist_tmp, _ = np.histogram(
...
def Cholesky(Corr_matrix):
    ...
    for i in range(npars):
        for j in range(i + 1):
            ...
            if i == j:
                L[i * npars + j] = sqrt(Corr_matrix[i * npars + i] - s)
            else:
                L[i * npars + j] = (
                    1 / L[j * npars + j] * (Corr_matrix[i * npars + j] - s)
                )
...
def resamplePSefficiency(efficiency):
    corr_matrix = np.load(
        "../PSEfficiency/correlation_matrix_{}_{}.npy".format(mode, year)
    )
    npars = corr_matrix.shape[0]
    ...
    a_shift = [
        (
            a[0] * Cholesky_matrix[npars * n + 0]
            + a[1] * Cholesky_matrix[npars * n + 1]
            + a[2] * Cholesky_matrix[npars * n + 2]
            + a[3] * Cholesky_matrix[npars * n + 3]
            + a[4] * Cholesky_matrix[npars * n + 4]
            + a[5] * Cholesky_matrix[npars * n + 5]
            + a[6] * Cholesky_matrix[npars * n + 6]
            + a[7] * Cholesky_matrix[npars * n + 7]
        )
    ...
    for i, param in enumerate(efficiency.getParameters()):
        print(
            "Resampling parameter {} original value: {}, new value: {}".format(
                param.getName(), c[i], new_coeffs[i]
            )
        )
...
def resample_LASS():
    ...
    LASS_params_csv = [
        params_csv.K0starm_1430_amp_real,
        params_csv.K0starm_1430_amp_imag,
        params_csv.K0starp_1430_amp_real,
        params_csv.K0starp_1430_amp_imag,
        params_csv.a,
        params_csv.r,
        params_csv.phiR,
        params_csv.F,
    ...
    LASS_params_errors = [
        params_csv.K0starm_1430_amp_real_err,
        params_csv.K0starm_1430_amp_imag_err,
        params_csv.K0starp_1430_amp_real_err,
        params_csv.K0starp_1430_amp_imag_err,
        params_csv.a_err,
        params_csv.r_err,
        params_csv.phiR_err,
        params_csv.F_err,
    ...
    for i, param in enumerate(LASS_params):
        if "K0star" in param.getName():
            continue  # Do not resample amplitudes
        print(
            "Resampling parameter {} original value: {}, new value: {}".format(
                param.getName(), params[i], new_coeffs[i]
            )
        )
        param.setValue(new_coeffs[i])
...
def main():
    ...
    for year in years:
        for mode in modes:
            ...
            mean = Variable(
                f"mean_{mode}_{year}", select_res_params["mean"][0] / (sigma.getValue())
            )
            coreScale = Variable(
                f"coreScale_{mode}_{year}",
                select_res_params["sigma"][0] / (sigma.getValue()),
            )  # Check parameters
            tailScale = Variable(
                f"tailScale_{mode}_{year}",
                select_res_params["sigma1"][0] / (sigma.getValue()),
            )
            outScale = Variable(
                f"outScale_{mode}_{year}",
                select_res_params["sigma2"][0] / (sigma.getValue()),
            )
            ...
            resolution = ThreeGaussResolution(
                coreFrac,
                tailFrac,
                mean,
                coreScale,
            ...
            BGPdf_dtime_hist = SmoothHistogramPdf(
                f"BGPdf_dtime_hist_{yearmode}", bghist_dtime, dtime_smoothing
            )
            ...
            total_pdfs[yearmode] = EventWeightedAddPdf(
                f"total_{yearmode}", [sigprob], [signal_pdf, BGPdf3D]
            )
    ...
    for year in years:
        for mode in modes:
            signal_pdfs[f"{year}_{mode}"].setDataSize(
                datasets[f"{year}_{mode}"].getNumEvents(), 9, offset
            )
