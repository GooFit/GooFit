...
conversion["2.0"] = [
    ...
    (
        r"goofit/PDFs/MixingTimeResolution.h",
        "goofit/PDFs/physics/MixingTimeResolution.h",
    ),
    ...
    (
        r"goofit/PDFs/ThreeGaussResolution.h",
        "goofit/PDFs/physics/ThreeGaussResolution.h",
    ),
...
conversion["2.1"] = [
    ...
    (
        r"ResonancePDF\((.*?)$",
        r"Resonances::RBW(\1 // Could also be LASS, GS, FLATTE, Gauss, NonRes",
    ),
    (r"LS::BW", r"LS::RBW"),
    (r"LS::ONE", r"LS::One"),
    ...
    (
        r"vector<Variable>\s*observable",
        r"vector<Observable> observable",
    ),  # Common pattern
]
