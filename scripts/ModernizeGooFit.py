...
conversion = [
    ...
    (r'goofit/PDFs/CorrGaussianPdf.h', 'goofit/PDFs/CorrGaussian/ArgusPdf.h'),
    ...
    (r'goofit/PDFs/GaussianPdf.h', 'goofit/PDFs/basic/GaissianPdf.h'),
    ...
    (r'goofit/PDFs/PolynomialPdf.h', 'goofit/PDFs/basic/PolynimialPdf.h'),
