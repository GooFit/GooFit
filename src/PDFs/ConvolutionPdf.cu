...
__host__ void ConvolutionPdf::setIntegrationConstants(fptype lo, fptype hi, fptype step) {
    ...
    MEMCPY_TO_SYMBOL(dev_modWorkSpace, dev_address, sizeof(fptype*), workSpaceIndex*sizeof(fptype*),
                     cudaMemcpyHostToDevice);
    dev_address[0] = (&((*resolWorkSpace)[0])).get();
    MEMCPY_TO_SYMBOL(dev_resWorkSpace, dev_address, sizeof(fptype*), workSpaceIndex*sizeof(fptype*),
                     cudaMemcpyHostToDevice);
}
