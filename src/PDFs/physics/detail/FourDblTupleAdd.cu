...
__host__ __device__ auto FourDblTupleAdd::
operator()(thrust::tuple<fptype, fptype, fptype, fptype> one, thrust::tuple<fptype, fptype, fptype, fptype> two) -> thrust::tuple<fptype, fptype, fptype, fptype> {
