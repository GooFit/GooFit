...
__device__ fpcomplex kMatrixRes(fptype m12, fptype m13, fptype m23, ParameterContainer &pc) {
    ...
    printf("phase space matrix is: %f %f \n", phaseSpace(0,0).real(), phaseSpace(0,0).imag() );
    printf("                       %f %f \n", phaseSpace(1,0).real(), phaseSpace(1,0).imag() );
    printf("                       %f %f \n", phaseSpace(2,0).real(), phaseSpace(2,0).imag() );
    printf("                       %f %f \n", phaseSpace(3,0).real(), phaseSpace(3,0).imag() );
    printf("                       %f %f \n", phaseSpace(4,0).real(), phaseSpace(4,0).imag() );
    printf("phsp_twoBody(s, mEta, mEtap) %f %f \n", teste.real(), teste.imag() );
    printf("adlerTerm =  %f \n", adlerTerm );

    Eigen::Array<fpcomplex, NCHANNELS, NCHANNELS> F,tMatrix;
...
//        printf("F(0, pterm) = (%f,%f), s0_prod = %f, s = %f\n", tMatrix(0, pterm).real(), F(0, pterm).imag(), s0_prod, s);
        printf("returning:\n");
        return fpcomplex(1,0);
        //return fpcomplex((1 - s0_prod) / (s - s0_prod),0);
