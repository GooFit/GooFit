...
void DebugTools::printDeviceVecComplexVals(thrust::device_vector<fpcomplex>::const_iterator first, thrust::device_vector<fpcomplex>::const_iterator last, 
					   thrust::iterator_difference<thrust::device_vector<fpcomplex>::const_iterator>::type stride, 
					   const std::string &codeLoc, int printLimit, int printPrecision)
{
    int numPrinted = 0;
